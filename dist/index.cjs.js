/*!
 * @nsourov/puppeteer-extra-plugin-recaptcha v4.0.1 by Naimur
 * https://github.com/nsourov/puppeteer-extra-plugin-recaptcha
 * @license MIT
 */
'use strict';
...
class RecaptchaContentScript {
    ...
    _isCaptchaChallengeWindowPresent() {
        return (Array.from(document.querySelectorAll(`iframe[src^='https://www.google.com/recaptcha/api2/bframe'][name^="c-"]`)).filter(x => window.getComputedStyle(x).visibility !== 'hidden').length >
            0);
    }
